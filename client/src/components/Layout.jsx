      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-16 items-center justify-between border-b border-slate-200/80 bg-white px-8">
          {project && (
            <div 
              onClick={() => navigate('/')}
              className="flex items-center justify-between rounded-lg border border-slate-200/80 p-2 hover:bg-slate-50 transition-colors cursor-pointer max-w-[280px]"
            >
              <div className="flex items-center gap-2 overflow-hidden">
                <img 
                  src={project.coverImage || "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=150"} 
                  alt={project.name} 
